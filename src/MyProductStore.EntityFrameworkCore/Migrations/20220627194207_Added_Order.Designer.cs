...
{
    [DbContext(typeof(MyProductStoreDbContext))]
    [Migration("20220627194207_Added_Order")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyProductStore.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("MyProductStore.Orders.OrderLine", b =>
                {
            ...
            modelBuilder.Entity("MyProductStore.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyProductStore.Orders.OrderLine", b =>
                {
                    b.HasOne("MyProductStore.Orders.Order", null)
                        .WithMany("OrderLines")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyProductStore.Products.Product", null)
                        .WithMany()
